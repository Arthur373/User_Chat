...
<%@ page import="am.gitc.chat.model.User" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Date" %>
<%@ page import="java.util.Map" %>
<%@ page import="am.gitc.chat.model.Message" %>
...
<div id="current-user-name" hidden="hidden"
     user-name='<c:out value="${sessionScope.user.name.concat(' ').concat(sessionScope.user.surname)}"/>'></div>
<div id="frame">
    <div id="sidepanel">
        <div id="profile">
            <div class="wrap">
        ...
        <div id="bottom-bar">
            <a href="/users/download?type=xlsx" style="color: white">Download Users xlsx</a>
            <a href="/users/download" style="color: white">Download Users csv</a>
        </div>
    </div>
    <div class="content">
